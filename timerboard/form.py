...
class TimerForm(forms.Form):
    ...
    days_left = forms.IntegerField(required=True, label="Reinforced Days Remaining", validators=[MinValueValidator(0)])
    hours_left = forms.IntegerField(required=True, label="Reinforced Hours Remaining", validators=[MinValueValidator(0), MaxValueValidator(23)])
    minutes_left = forms.IntegerField(required=True, label="Required Minutes Remaining", validators=[MinValueValidator(0), MaxValueValidator(59)])
